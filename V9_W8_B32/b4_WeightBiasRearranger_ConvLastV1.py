...
def process_convlast_weights(weight_file, bias_file, output_folder):
    # 建立輸出資料夾
    ...
    print(f"偵測到 {actual_groups} 組 ConvLast Filter 資料，開始轉換...")
...
def run_all():
    # 設定輸入檔名
    W_FILE = "data_model_8_32/conv_last.0_w.txt"
    B_FILE = "data_model_8_32/conv_last.0_b.txt"
